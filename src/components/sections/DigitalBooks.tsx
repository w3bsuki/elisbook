    ...
    <section className="py-24 bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="flex flex-col flex-grow p-5 pt-4 border-t-2 border-blue-600/20 dark:border-blue-600/10 mt-3 bg-gray-50 dark:bg-gray-800/80">
                  ...
                  <div className="flex gap-2 mt-auto">
                    <Button 
                      variant="outline"
                      size="sm"
                      className="border-blue-600 text-blue-600 hover:bg-blue-50 dark:border-blue-500 dark:text-blue-500 dark:hover:bg-blue-950/30 flex-1 h-8 text-xs"
                      onClick={() => handleBookClick(book)}
                    >
                    ...
                    <Button 
                      size="sm"
                      className={cn(
                        "bg-blue-600 hover:bg-blue-700 text-white flex-1 h-8 text-xs",
        ...
        <div className="flex justify-center mt-16">
          <Button 
            variant="outline"
            className="border-blue-600 text-blue-600 hover:bg-blue-50 dark:border-blue-500 dark:text-blue-500 dark:hover:bg-blue-950/30 group border-2 px-6 py-5 h-auto"
            asChild
          >
