...
import { Calendar, Clock, Package, User, Search, SlidersHorizontal } from 'lucide-react';
    ...
    <div className="flex flex-col h-full group relative overflow-hidden border-2 border-black dark:border-gray-700 bg-white dark:bg-gray-800/50 rounded-lg transition-all duration-300 hover:shadow-[5px_5px_0px_0px_rgba(22,163,74,0.5)] dark:hover:shadow-[5px_5px_0px_0px_rgba(22,163,74,0.3)]">
      ...
      <div className="p-3 flex flex-col flex-grow">
        ...
        <div className="flex gap-1 mt-auto">
          ...
          <Button 
            size="sm"
            className="bg-green-600 hover:bg-green-700 text-white flex-1 h-7 text-[10px] border border-black dark:border-gray-700 shadow-[1px_1px_0px_0px_rgba(0,0,0,1)] dark:shadow-[1px_1px_0px_0px_rgba(255,255,255,0.2)] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] dark:hover:shadow-[2px_2px_0px_0px_rgba(255,255,255,0.2)] transition-all duration-300 rounded-sm"
            asChild
          >
